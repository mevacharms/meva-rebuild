    ...
    <>
      <div className="min-h-screen bg-[#F5F0FB] px-4 py-5 sm:px-5 sm:py-7">
        <div className="mx-auto flex min-h-screen max-w-[430px] flex-col items-center justify-center">
          <a href="/" aria-label="Go to Meva landing page" className="mb-4">
            <img
              src={MEVA_LOGO_URL}
              alt="Meva logo"
          ...
          <div className="w-full rounded-[34px] border border-white/80 bg-[#FFFDFE] px-5 pb-5 pt-5 shadow-[0_20px_70px_rgba(95,72,150,0.11)] sm:px-6 sm:pb-6 sm:pt-6">
            ...
            <h1 className="mx-auto max-w-[330px] text-center text-[28px] font-black leading-[0.98] tracking-[-0.03em] text-[#30215A] sm:max-w-[360px] sm:text-[35px]">
